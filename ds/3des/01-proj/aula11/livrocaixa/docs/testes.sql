...
(1,'Pagamento de fornecedor', 100.00, 'saida', date_sub(now(), interval 148 hour)),
...
(1,'Pagamento de fornecedor', 100.00, 'saida', date_sub(now(), interval 96 hour)),
(1,'Venda pelo site', 149.99,'entrada', date_sub(now(), interval 95 hour)),
(1,'Venda pelo site', 99.99,'entrada', date_sub(now(), interval 94 hour)),
...
(1,'Pagamento de fornecedor', 100.00, 'saida', date_sub(now(), interval 75 hour)),
(1,'Venda pelo site', 149.99,'entrada', date_sub(now(), interval 73 hour)),
(1,'Venda pelo site', 99.99,'entrada', date_sub(now(), interval 70 hour)),
...
(2,'Pagamento de fornecedor', 100.00, 'saida', date_sub(now(), interval 48 hour)),
...
(2,'Venda pelo site', 99.99,'entrada', date_sub(now(), interval 44 hour)),
...
(2,'Venda pelo site', 99.99,'entrada', date_sub(now(), interval 28 hour)),
...
(1,'Pagamento de fornecedor', 100.00, 'saida', date_sub(now(), interval 5 hour)),
(1,'Venda pelo site', 149.99,'entrada', date_sub(now(), interval 4 hour)),
(1,'Venda pelo site', 89.99,'entrada', date_sub(now(), interval 3 hour)),
(1,'Venda pelo site', 99.99,'entrada', date_sub(now(), interval 3 hour)),
(1,'Venda pelo site', 79.99,'entrada', date_sub(now(), interval 2 hour)),
(1,'Venda pelo site', 39.99,'entrada', date_sub(now(), interval 2 hour)),
