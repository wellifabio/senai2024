...
function App() {
  ...
  useEffect(() => {
    const backgrounds = ['images/image1.gif', 'images/image2.jpg', 'images/image3.jpg']; // Adicione aqui os caminhos para suas imagens de fundo
  ...
  return (
    ...
    <Navbar bg="light" variant="light">
        ...
        <Navbar.Brand href="#home">
            <img
              src={logo} // Aqui você define o src do logo (formato GIF)
              width="60"
              height="40"
